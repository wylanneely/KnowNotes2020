...
struct Instrument {
    ...
    fileprivate let C_sax = Note(name: "C", id: 2, soundPath: "sax_c2.wav")
    fileprivate let D_sax = Note(name: "D", id: 3, soundPath: "sax_d2.wav")
    fileprivate let E_sax = Note(name: "E", id: 4, soundPath: "sax_e2.wav")
