...
class Lesson {
    ...
    lazy var round1Notes: [Note] = instrumentName.round1Notes
    lazy var round2Notes: [Note] = instrumentName.round2Notes
    lazy var round3Notes: [Note] = instrumentName.round3Notes
